...
class webdriver_chrome():
    ...
    def open_web(self):
        ...
        christmasTag = self.driver.find_element_by_id('f_2561406_1')
        christmasTag.click()
        self.driver.close()


        TextBox3 = self.driver.find_element(By.TAG_NAME, "iframe")
        TextBox3 = self.driver.find_element(By.TAG_NAME, "iframe")
        TextBox3 = self.driver.find_element(By.TAG_NAME, "iframe")
        TextBox3 = self.driver.find_element(By.TAG_NAME, "iframe")
        

        TextBox3 = self.driver.find_element(By.CLASS_NAME, "aspNetDisabled")
        TextBox3 = self.driver.find_element(By.CLASS_NAME, "container-fluid")   #ok
        TextBox3 = self.driver.find_element(By.CLASS_NAME, "report")   #ok


        TextBox3 = self.driver.find_elements()
        TextBox3 = self.driver.find_element(By.NAME, "ReportViewerControl$ctl04$ctl03$ddValue")
        TextBox3 = self.driver.find_element(By.NAME, "ReportViewerControl$ctl07$img")
        TextBox3 = self.driver.find_element(By.NAME, "ReportViewerControl$ToggleParam$img")
        TextBox3 = self.driver.find_element(By.CLASS_NAME, "ReportViewerControl$ctl04$ctl03$ddValue")

        
        TextBox3 = self.driver.find_element(By.CLASS_NAME, "ReportViewerControl_ctl04_ctl03")
        ...
        TextBox3 = self.driver.find_element(By.CLASS_NAME, "container-fluid")   #ok
        TextBox3 = self.driver.find_element(By.CLASS_NAME, "report")   #ok
        TextBox3 = self.driver.find_element(By.CLASS_NAME, "subnav navbar-fixed-top ng-scope")

        
        
        
        TextBox3 = self.driver.find_element(By.ID, "ReportViewerControl_ctl04_ctl05")
        TextBox3 = self.driver.find_element(By.ID, "ReportViewerControl_ctl04_ctl03_ddValue")
